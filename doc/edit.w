...
\node [emit, text width=4cm, fill=yellow!40] (n-grammarInfoNotAvailable) {emit grammarInfoNotAvailable};
\node [emit, text width=4cm, fill=yellow!40] (n-networkError) {emit networkError};
