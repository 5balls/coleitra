...
\verb#fi-conj# & \\
\verb#fi-conj-ei# & \\
\verb#fi-conj-huutaa# & \verb#parse_fi_verbs# \\
...
\section{Helper script to get templates}

This helper script queries recursively for Template pages and can be used to create the TODO lists for the various languages above. Executable flag needs to be set manually (nuweb does not seem to provide the option to set this flags in the source documentation).
